...
The “job” of a Product Manager, at its core, is actually pretty simple. Ultimately, the Product Manager is responsible for the success of the products and features they oversee within a company. How they go about defining and obtaining that success is the tricky part. Before jumping into the role itself, we think it’d be helpful to explain a bit about how the function of “Product Manager” got started.
...
Ok, so back to the original question. We think Martin does an excellent job of answering this question in his post [What Exactly is a Product Manager?](https://www.mindtheproduct.com/2011/10/what-exactly-is-a-product-manager/). We promise we won't exclusively link to his content, but as one of the most well-regarded voices in the Product Management community, we think he does a great job of setting the table for us.
...
So now that we understand the job to be done, and how users are measuring success or failure for this particular job, how does this affect how we segment users? The post [Market Segmentation Through a Jobs to Be Done Lens](https://jobs-to-be-done.com/market-segmentation-through-a-jobs-to-be-done-lens-5ef9242de65), also by Tony Ulwick. Here, Tony explains why typical methods of market segmentation are often inneffective for creating helpful products. 
